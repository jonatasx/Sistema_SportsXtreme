...
<html>
    ...
    <body>
        ...
        <div class="container">
            <iframe name="post" src="" width="100%" height="80%" frameborder="0" style="margin-top: 100px"></iframe>
            <!-- The Modal -->
            ...
            <center>
                ...
                ?>
                <h5> Para ver os posts,clique em posts de cursos.
                    obs: Esse site foi criado para você que procura adrenalina,
                    professores devem cadastrar suas contas e criar seus cursos primeiro,
                    para depois criar os posts.
                </h5>
            </center>
           
            <?php
            include '../Sistema_SportsXtreme/footer.php';
